...
#let translation_cover(
  ...
  align(center)[
    ...
    #let info_row(key,value)=[#key:#h(2.5em)#box(width: 58%,stroke: (bottom:black),outset: 4pt)[#align(center)[#value]]]
    #set text(size: 18pt)
    #block(width: 80%)[
...
#let bachelor_cover(
  ...
  grid(
    ...
    column-gutter:12pt,
    row-gutter: 1.5em,
    [],[学#h(2em)号：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,student_id)],[],
    [],[姓#h(2em)名：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,name)],[],
    [],[学#h(2em)院：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,college)],[],
    [],[专#h(2em)业：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,major)],[],
    [],[指导教师：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,supervisor)],[],
    [],[起止日期：],[#box(stroke: (bottom:0.5pt),outset:6pt,width:100%,duration)],[],
  )
}
...
#let bachelor_conf(
  ...
  set page(numbering: (..idx)=>{text(size:9pt,numbering("I",idx.pos().first()))}) //numbering setting must be before update()。正文前用罗马数字编号。
  counter(page).update(1)
