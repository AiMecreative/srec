...
对于单独的STR任务而言，目前有许多诸如COCO-Text~@coco-text 等数据集用于模型推理测试，而用于STISR和STR双任务的数据集目前常用的是TextZoom~@tsrn 其中包含了17367张训练图片和三个难度档次的测试集：easy难度的1619张图片，medium难度的1411张图片和hard难度的1343张图片。
